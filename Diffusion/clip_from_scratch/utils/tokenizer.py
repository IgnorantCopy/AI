...
def canonicalize_text(
    ...
    *,
    ...
    Args:
      ...
      trans_punctuation: If provided, then this string will be used to replace
        all punctuation characters. For example providing '_' will replace all
        punctuation with underscores.
    """
    if trans_punctuation is None:
