...
class ViT(nn.Module):
    def __init__(self, dim, depth, heads, mlp_dim, image_size=224, patch_size=16, num_classes=10, in_channels=3, dim_head=64, dropout=0., emb_dropout=0.):
        super().__init__()
        ...
        self.pos_embedding = nn.Parameter(torch.randn(1, (image_size // patch_size) * (image_size // patch_size) + 1, dim))
