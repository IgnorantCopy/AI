...
def define_G(opt):
    ...
    if net_type == 'msrresnet':
        from ImageInpainting.train.networks.network_srresnet import MSRResNet as net
...
def define_D(opt):
    ...
    if net_type == 'discriminator_unet':
        from ImageInpainting.train.networks.network_discriminator import Discriminator_UNet as discriminator
